...
os.system("wget --no-check-certificate -O /storage/install-iarl.sh https://github.com/bite-your-idols/Gamestarter-Pi/raw/master/assets/install_iarl.sh && sh /storage/install-iarl.sh")
