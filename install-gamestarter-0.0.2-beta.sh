...
echo ''
echo '::Gamestarter-01/11:: -> downloading RetroArch...' 
echo ''
...
echo '' 
echo '::Gamestarter-02/11:: -> downloading Libretro cores...'
echo ''
...
# descargar amiga
echo ''
echo '::Gamestarter-03/11:: -> downloading uae4arm...'
echo '' 
...
echo ''
echo '::Gamestarter-04/11:: -> downloading emulationstation...'
echo '' 
...
echo ''
echo '::Gamestarter-05/11:: -> downloading Gamestarter scripts...' 
echo ''
...
echo ''
echo '::Gamestarter-06/11:: -> downloading RetroArch launcher addon...' 
echo ''
...
echo ''
echo '::Gamestarter-07/11:: -> downloading uae4arm launcher addon and libs...' 
echo ''
...
# instalar el addon/libs de emualtionstation
echo ''
echo '::Gamestarter-08/11:: -> downloading emualtionstation launcher addon and libs...' 
echo ''
# wget --no-check-certificate -O /storage/downloads/script.gamestarter.uae4arm.tar.gz https://github.com/bite-your-idols/script.gamestarter.uae4arm/archive/0.0.2.tar.gz
...
echo ''
echo '::Gamestarter-09/11:: -> downloading AdvancedLauncher, assets and sample roms...'
echo ''
...
echo ''
wget --no-check-certificate -O /storage/downloads/iarl.tar.gz https://github.com/bite-your-idols/plugin.program.iarl/archive/master.tar.gz
...
# Lo de Gamemaker Pi
echo ''
echo '::Gamestarter-11/11:: -> downloading GameMaker Pi ports and requiered libs...'
echo ''
