...
then
	...
	then
		...
		then
			...
			rm -rf $CONFIG_DIRECTORY/plugin.program.advanced.launcher
		...
		then
			...
			rm -rf $CONFIG_DIRECTORY/plugin.program.advanced.emulator.launcher
	...
	then
		...
		cp -ar $CONFIG_DIRECTORY/emulationstation $BACKUP_DIRECTORY/script.gamestarter
	fi
