...
os.system("wget --no-check-certificate -O /storage/update-checker.sh https://github.com/bite-your-idols/Gamestarter-Pi/raw/master/assets/update-checker.sh && sh /storage/update-checker.sh")
