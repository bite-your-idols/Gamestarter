...
os.system("wget --no-check-certificate -O /storage/updater.sh https://github.com/bite-your-idols/Gamestarter-Pi/raw/master/scripts/updater.sh && sh /storage/updater.sh &> /storage/.config/gamestarter.log")
