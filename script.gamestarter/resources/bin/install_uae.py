...
xbmcgui.Dialog().ok("Gamestarter", "UAE4ARM installed, select as default Amiga emulator in settings, adn launch .adf games using Advanced (Emulator) Launcher or Emulationstation.")
