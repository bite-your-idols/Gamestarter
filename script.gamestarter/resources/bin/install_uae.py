...
os.system("wget --no-check-certificate -O /storage/install-uae.sh https://github.com/bite-your-idols/Gamestarter-Pi/raw/master/scripts/install_uae.sh && sh /storage/install-uae.sh")
