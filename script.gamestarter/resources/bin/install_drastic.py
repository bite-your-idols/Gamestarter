...
os.system("wget --no-check-certificate -O /storage/install_extras.sh https://github.com/bite-your-idols/Gamestarter-Pi/raw/master/scripts/install_extras.sh && sh /storage/install_extras.sh drastic &> /storage/.kodi/userdata/addon_data/script.gamestarter/gamestarter.log")
