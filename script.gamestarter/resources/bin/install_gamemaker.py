...
os.system("wget --no-check-certificate -O /storage/install-gm.sh https://github.com/bite-your-idols/gamemaker-pi/raw/master/gamemaker-gamestarter.sh && sh /storage/install-gm.sh")
