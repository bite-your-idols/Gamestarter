...
PKG_NAME="beetle-pce-fast-libretro"
PKG_VERSION="39185a6" #28/01/17
PKG_ARCH="any"
PKG_LICENSE="GPLv2"
...
unpack() {
  ...
  mv $BUILD/beetle-pce-fast* $BUILD/$PKG_NAME-$PKG_VERSION
}

makeinstall_target() {
  # mkdir -p $INSTALL/usr/lib/libretro
  # cp beetle-pce-fast_libretro.so $INSTALL/usr/lib/libretro/
  :
}
