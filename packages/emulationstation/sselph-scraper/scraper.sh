...
# /storage/.config/emulationstation/sselph-scraper/scraper -image_suffix="" -console_img="b"  -rom_dir="/var/media/SERIES_2T/Emuladores/roms/nes" -output_file="/storage/.config/emulationstation/gamelists/nes/gamelist.xml" -workers=3  -add_not_found=true -image_dir="/storage/.config/emulationstation/artworks/nes"
#  /storage/.config/emulationstation/sselph-scraper/scraper -image_suffix="_fanart" -console_img="f"  -rom_dir="/var/media/SERIES_2T/Emuladores/roms/nes" -output_file="/storage/.config/emulationstation/gamelists/nes/gamelist.xml" -workers=3  -add_not_found=true -image_dir="/storage/.config/emulationstation/artworks/nes"
