...
ROMS_PATH="/var/media/SERIES_2T/Emuladores/roms"
ARTS_PATH="/var/media/SERIES_2T/Emuladores/arts"
TIPO=$2
...
if [ "$CONSOLE" = "all" ]; then
	...
	if [ "$TIPO" = "fanart" ]; then
		...
		ARTS_PATH="/var/media/SERIES_2T/Emuladores/arts-"$CONSOLE
		IMG_SUFFIX=""
		IMG_TYPE="s"
		IMG_WIDTH=1200
...
#thumbs
#/storage/.config/emulationstation/sselph-scraper/scraper -image_suffix="" -console_img="b" -max_width=600 -rom_dir="/var/media/SERIES_2T/Emuladores/roms/gb" -workers=3  -add_not_found=true -image_dir="/var/media/SERIES_2T/Emuladores/arts_ES/gb"
#fanarts
# /storage/.config/emulationstation/sselph-scraper/scraper -image_suffix="_fanart" -console_img="s"  -max_width=1200 -rom_dir="/var/media/SERIES_2T/Emuladores/roms/gb" -workers=3  -add_not_found=true -image_dir="/var/media/SERIES_2T/Emuladores/arts_ES/gb"
