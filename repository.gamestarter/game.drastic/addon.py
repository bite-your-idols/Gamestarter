...
os.system("echo 'DraStic [ADDON] ::' $(date) > /storage/.kodi/temp/drastic.log")
os.system("echo '============================================================' >> /storage/.kodi/temp/drastic.log")
...
os.system("chmod a+x /storage/.kodi/addons/game.drastic/addon.sh")
os.system("chmod a+x /storage/.kodi/addons/game.drastic/addon.start")
os.system("chmod a+x /storage/.kodi/addons/game.drastic/drastic/drastic")
