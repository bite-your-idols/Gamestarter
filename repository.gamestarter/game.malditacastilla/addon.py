...
os.system("echo 'PPSSPP [ADDON] ::' $(date) > /storage/.kodi/temp/malditacastilla.log")
os.system("echo '============================================================' >> /storage/.kodi/temp/malditacastilla.log")
...
# os.system("chmod a+x /storage/.kodi/addons/game.malditacastilla/addon.sh")
# os.system("chmod a+x /storage/.kodi/addons/game.malditacastilla/addon.start")
# os.system("chmod a+x /storage/.kodi/addons/game.malditacastilla/game.malditacastilla")
...
xbmcgui.Dialog().ok(addonname, "Foo.")